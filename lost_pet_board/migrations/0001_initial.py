    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image1', models.ImageField(upload_to='', validators=[lost_pet_board.models.validate_image])),
                ('image2', models.ImageField(blank=True, upload_to='', validators=[lost_pet_board.models.validate_image])),
                ('image3', models.ImageField(blank=True, upload_to='', validators=[lost_pet_board.models.validate_image])),
                ('lost_board_no', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='board_image', to='lost_pet_board.lostpetboard')),
            ],
            options={

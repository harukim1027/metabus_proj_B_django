# Generated by Django 3.2.12 on 2022-04-06 15:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('find_board_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='find_owner_board.findownerboard')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={

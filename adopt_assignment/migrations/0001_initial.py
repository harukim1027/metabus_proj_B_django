    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('home_image1', models.ImageField(upload_to='', validators=[adopt_assignment.models.validate_image])),
                ('home_image2', models.ImageField(upload_to='', validators=[adopt_assignment.models.validate_image])),
                ('home_image3', models.ImageField(upload_to='', validators=[adopt_assignment.models.validate_image])),
                ('assignment_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adopt_assignment.adoptassignment')),
            ],
            options={
